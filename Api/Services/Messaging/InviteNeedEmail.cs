...
{
    public class InviteNeedEmail  : IMessage
    {
        ...
        public InviteNeedEmail(string _recipient, string _name, string _invitorName, string _needName, string _company, string _needLink)
        {
